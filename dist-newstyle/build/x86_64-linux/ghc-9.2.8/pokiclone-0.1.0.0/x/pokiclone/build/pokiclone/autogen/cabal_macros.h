...
/* package pokiclone-0.1.0.0 */
#ifndef VERSION_pokiclone
#define VERSION_pokiclone "0.1.0.0"
#endif /* VERSION_pokiclone */
#ifndef MIN_VERSION_pokiclone
#define MIN_VERSION_pokiclone(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pokiclone */
...
/* package h-raylib-5.1.1.0 */
#ifndef VERSION_h_raylib
#define VERSION_h_raylib "5.1.1.0"
...
#define CURRENT_COMPONENT_ID "pokiclone-0.1.0.0-inplace-pokiclone"
